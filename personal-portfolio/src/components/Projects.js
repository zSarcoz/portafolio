...
export const Projects = () => {
  ...
  return (
    <section className="project" id="project">
          ...
          <Col size={12}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                <h2>Projects</h2>
                <p>These are the projects I have done so far. By clicking on them you can enter the pages of each one.</p>
      ...
      <img className="background-image-right" src={colorSharp2} alt="charp"></img>
    </section>
  )
}
