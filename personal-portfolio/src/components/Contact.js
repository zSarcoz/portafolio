          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                <form action="https://formspree.io/f/mvoygwea"
  method="POST">
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} name="tel" placeholder="Phone No." onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
